            ...
            while(seleccion1){
                switch(seleccion1){
                    ...
                    case 2:
                        ...
                        alert(`La suma total es de $`+ multiplicar(precio2,seleccion2));
                        break
                    case 3:
                        seleccion2 = parseInt(prompt(`Usted seleccionó` + productoC + ` Que tiene un valor de: $`+ precio3 + "\n Que cantidad desea?"));
                        alert(`La suma total es de $`+ multiplicar(precio3,seleccion2));
                        break
                    case 4:
                        seleccion2 = parseInt(prompt(`Usted seleccionó` + productoD + ` Que tiene un valor de: $`+ precio4 + "\n Que cantidad desea?"));
                        alert(`La suma total es de $`+ multiplicar(precio4,seleccion2));
                        break;
